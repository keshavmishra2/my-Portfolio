  ...
  return (
    ...
    >
      <div className={styles.container}>
        ...
        <p style={{ color: `${newTheme.para}` }} className={styles.paragraph}>
          ...
          <p style={{ color: `#00a0a0`, lineHeight: ``,fontSize:`20px` }}>
            {/* {" "} */}
            Email: keshavmishra018@gmail.com
          </p>

		  <p style={{ color: `#00a0a0`,fontSize:`20px`}}>
		  Mobile: +91-<span style={{ color: `#00a0a0`, fontSize:`20px`, textDecoration: `underline` }} >8308347825</span>{'\u00A0'}{'\u00A0'}{'\u00A0'}{'\u00A0'}{'\u00A0'}{'\u00A0'}
          </p>
		  <p style={{ color: `#00a0a0`,fontSize:`20px` }}>
        ...
        >
          ...
          <a
            href="mailto: keshavmishra018@gmail.com"
            aria-label="email"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <a
            href="https://twitter.com/Keshavm49947607"
            aria-label="Twitter"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <a
            href="https://github.com/keshavmishra2"
            aria-label="GitHub"
            rel="noreferrer"
            target="_blank"
          >
          ...
          <a
            href="https://www.linkedin.com/in/keshav-mishra-55353418b/"
            aria-label="Linkedin"
            target="_blank"
            rel="noreferrer"
          >
      ...
      <div style={{ color: `${newTheme.para}` }} className={styles.copyright}>
        Designed and build by Keshavkumar Mishra, 2022 All rights reserved.
      </div>
    </footer>
  );
};
